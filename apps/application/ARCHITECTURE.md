...
- **`locator_usages`** — the locator index: one row per (test case, Playwright project, call site, action, canonical
  chain), read from the steps of each ingested execution. Feeds "Who uses this?", the project's Locators page and the
