  ...
  openAPI: {
    ...
    parameters: [
      ...
      },
      {
        ...
        in: 'query',
        required: false,
        schema: { type: 'string', enum: ['json', 'html', 'pdf', 'md', 'csv', 'xlsx'], default: 'json' },
      },
