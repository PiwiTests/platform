...
CREATE UNIQUE INDEX `idx_graph_edges_unique` ON `graph_edges` (`project_id`,`from_kind`,`from_key`,`kind`,`to_kind`,`to_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `idx_graph_nodes_project_kind_key` ON `graph_nodes` (`project_id`,`kind`,`key`);--> statement-breakpoint
