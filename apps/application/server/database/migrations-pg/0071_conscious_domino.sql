...
CREATE INDEX "idx_graph_nodes_project_kind_branch" ON "graph_nodes" USING btree ("project_id","kind","branch");--> statement-breakpoint
...
CREATE INDEX "idx_scenario_gaps_pr" ON "scenario_gaps" USING btree ("project_id","pr_number");--> statement-breakpoint
