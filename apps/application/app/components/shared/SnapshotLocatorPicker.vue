...
// (Re)load of the srcdoc document — a new snapshot, a source switch, or a
// re-pick (renderKey bump) — re-arms the timer; a document going away clears it.
watch([pickerDoc, renderKey], () => {
  if (pickerDoc.value) armReadyTimer();
