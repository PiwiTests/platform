...
const changed = computed(() =>
  triageStatus.value !== props.initialStatus
  || triageNote.value.trim() !== props.initialNote
)
  ...
  <div class="pt-4 max-w-lg">
    <UCard>
      <div class="space-y-4">
        ...
        <UFormField
          label="Note"
          description="Optional context about this cluster's resolution or workaround"
        >
          <UTextarea
            v-model="triageNote"
