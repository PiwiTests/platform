  ...
  <UCard>
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div v-if="testCase.slowestStep">
          ...
          <p class="font-medium text-orange-600">
            ...
            <span v-if="testCase.slowestStepDuration" class="text-sm">({{ formatDuration(testCase.slowestStepDuration) }})</span>
          </p>
        </div>
      </div>
      ...
      <div v-if="historicalTiming" class="pt-3 border-t">
        ...
        <p class="font-medium">
          <span :class="historicalTiming.pct > 10 ? 'text-red-600' : historicalTiming.pct < -10 ? 'text-green-600' : 'text-gray-500'">
          ...
          <span
            class="ml-2 text-sm"
            :class="historicalTiming.pct > 0 ? 'text-red-500' : 'text-green-500'"
          >
