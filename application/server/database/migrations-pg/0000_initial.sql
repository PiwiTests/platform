...
ALTER TABLE "reports" ADD CONSTRAINT "reports_test_run_id_test_runs_id_fk" FOREIGN KEY ("test_run_id") REFERENCES "public"."test_runs"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "traces" ADD CONSTRAINT "traces_test_runs_case_id_test_runs_cases_id_fk" FOREIGN KEY ("test_runs_case_id") REFERENCES "public"."test_runs_cases"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_reports_test_run_id" ON "reports" USING btree ("test_run_id");--> statement-breakpoint
CREATE INDEX "idx_test_cases_project_id" ON "test_cases" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "idx_test_cases_file_path_title" ON "test_cases" USING btree ("file_path","title");--> statement-breakpoint
...
CREATE INDEX "idx_traces_test_runs_case_id" ON "traces" USING btree ("test_runs_case_id");